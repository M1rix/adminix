...
!(function (t, e) {
  ...
  var a = new (class {
    ...
    _update(t = Date.now()) {
      ...
      e._charts.forEach((n, o) => {
        ...
        for (; r >= 0; --r)
          (a = s[r]),
            a._active ? (a._total > n.duration && (n.duration = a._total), a.tick(t), (l = !0)) : ((s[r] = s[s.length - 1]), s.pop());
    ...
    start(t) {
      ...
      e &&
        ((e.running = !0), (e.start = Date.now()), (e.duration = e.items.reduce((t, e) => Math.max(t, e._duration), 0)), this._refresh());
    }
    running(t) {
  ...
  function I(t) {
    ...
    return (
      Array.isArray(t)
        ? t.length >= 3 && ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = m(t[3])))
  ...
  class z {
    constructor(t) {
      ...
      'object' === e
        ...
        : 'string' === e &&
          ...
          '#' === n[0] &&
            (4 === s || 5 === s
              ? (o = { r: 255 & (17 * r[n[1]]), g: 255 & (17 * r[n[2]]), b: 255 & (17 * r[n[3]]), a: 5 === s ? 17 * r[n[4]] : 255 })
              : (7 !== s && 9 !== s) ||
                (o = {
                  r: (r[n[1]] << 4) | r[n[2]],
                  g: (r[n[3]] << 4) | r[n[4]],
    ...
    rgbString() {
      return this._valid
        ? (t = this._rgb) && (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${x(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`)
        : this._rgb;
      var t;
    }
    hexString() {
  ...
  function Yt(t, e, i, n) {
    ...
    for (l = 0; l < r; l++)
      ...
      else if (Y(d)) for (c = 0, h = d.length; c < h; c++) (u = d[c]), null == u || Y(u) || (a = $t(t, o, s, a, u));
    t.restore();
    const f = s.length / 2;
    if (f > i.length) {
  ...
  function qt(t, e, i, n) {
    ...
    const c = e.pointStyle,
      ...
      d = e.radius;
    let u = (h || 0) * vt;
    if (c && 'object' == typeof c && ((o = c.toString()), '[object HTMLImageElement]' === o || '[object HTMLCanvasElement]' === o))
      return t.save(), t.translate(i, n), t.rotate(u), t.drawImage(c, -c.width / 2, -c.height / 2, c.width, c.height), void t.restore();
    if (!(isNaN(d) || d <= 0)) {
  ...
  function pe(t, e) {
    ...
    return (
      ...
      { x: Math.round((((l - d) / f) * i.width) / n), y: Math.round((((c - u) / g) * i.height) / n) }
    );
  }
  ...
  function be(t, e, i) {
    ...
    (o.height = a * n),
      ...
      o.style && (i || (!o.style.height && !o.style.width)) && ((o.style.height = a + 'px'), (o.style.width = s + 'px'));
  }
  const _e = (function () {
    let t = !1;
    try {
        ...
        r = (function (t) {
          const e = (function (t) {
              ...
              for (i = 0, n = (t || []).length; i < n; ++i)
                (o = t[i]), e.push({ index: i, box: o, pos: o.position, horizontal: o.isHorizontal(), weight: o.weight });
              return e;
            })(t),
            i = We(
    ...
    acquireContext(t, e) {
      ...
      return i && i.canvas === t
        ? ((function (t, e) {
            ...
            if (
              ((t.$chartjs = { initial: { height: n, width: o, style: { display: i.display, height: i.height, width: i.width } } }),
  ...
  const hi = t => 0 === t || 1 === t,
    ...
    ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * bt) / i) + 1,
      ...
      easeInOutExpo: t => (hi(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
  ...
  class mi {
    ...
    tick(t) {
      ...
      i < 0
        ? (e._target[o] = s)
        : ((l = (i / n) % 2), (l = a && l > 1 ? 2 - l : l), (l = e._easing(Math.min(1, Math.max(0, l)))), (e._target[o] = e._fn(s, r, l)));
    }
    wait() {
  ...
  mt.describe('animation', { _fallback: !1, _indexable: !1, _scriptable: t => 'onProgress' !== t && 'onComplete' !== t && 'fn' !== t }),
    mt.set('animations', {
  ...
  class Ai {
    ...
    _dataCheck() {
      ...
      U(i)
        ...
        : t._data !== i && (t._data && (re(t._data, t), Pi(t._cachedMeta)), i && Object.isExtensible(i) && ae(i, t), (t._data = i));
    }
    addElements() {
      const t = this,
        e = t._cachedMeta;
    ...
    parseObjectData(t, e, i, n) {
      const { xScale: o, yScale: s } = t,
        ...
        l = new Array(n);
      let c, h, d, u;
      for (c = 0, h = n; c < h; ++c) (d = c + i), (u = e[d]), (l[c] = { x: o.parse(lt(u, a), d), y: s.parse(lt(u, r), d) });
      return l;
    }
    getParsed(t) {
    ...
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        a &&
        ((n.values = a), (t.min = Math.min(t.min, s)), (t.max = Math.max(t.max, s)), (s = vi(n, o, this._cachedMeta.index, { all: !0 }))),
  ...
  function Bi(t, e, i) {
    ...
    if (
      !(
        i &&
        ((l = 1 === n ? Math.max(c - s, a - c) : 0 === e ? (t.getPixelForTick(1) - c) / 2 : (c - t.getPixelForTick(o - 1)) / 2),
        (c += o < e ? l : -l),
        c < s - r || c > a + r)
      )
    )
  ...
  class ji extends Oi {
    ...
    getMinMax(t) {
      ...
      for (let l = 0, c = r.length; l < c; ++l)
        (i = r[l].controller.getMinMax(e, t)), s || (n = Math.min(n, i.min)), a || (o = Math.max(o, i.max));
    ...
    update(t, e, i) {
      ...
      n.beforeUpdate(),
        ...
        n._dataLimitsCached || (n.beforeDataLimits(), n.determineDataLimits(), n.afterDataLimits(), (n._dataLimitsCached = !0)),
        n.beforeBuildTicks(),
      ...
      n._convertTicksToLabels(a ? Vi(n.ticks, s) : n.ticks),
        ...
        o.display && (o.autoSkip || 'auto' === o.source) && ((n.ticks = Ii(n, n.ticks)), (n._labelSizes = null)),
    ...
    fit() {
      ...
      if (a) {
        ...
        if (
          (r ? ((e.width = t.maxWidth), (e.height = Wi(s) + a)) : ((e.height = t.maxHeight), (e.width = Wi(s) + a)),
      ...
      t._handleMargins(),
        r
          ? ((t.width = t._length = i.width - t._margins.left - t._margins.right), (t.height = e.height))
          : ((t.width = e.width), (t.height = t._length = i.height - t._margins.top - t._margins.bottom));
    }
    ...
    getContext(t) {
      ...
      return (
        e.$context || (e.$context = ((n = e.chart.getContext()), (o = e), Object.assign(Object.create(n), { scale: o, type: 'scale' })))
      );
      var n, o;
    }
    _tickSize() {
      ...
      return (
        'left' === i
          ? o
            ? ((l = 'left'), (c = e.right - s))
            : ((c = e.right - a),
              'near' === n ? (l = 'right') : 'center' === n ? ((l = 'center'), (c -= r / 2)) : ((l = 'left'), (c = e.left)))
          : 'right' === i
          ? o
            ? ((l = 'right'), (c = e.left + s))
            : ((c = e.left + a),
              'near' === n ? (l = 'left') : 'center' === n ? ((l = 'center'), (c += r / 2)) : ((l = 'right'), (c = e.right)))
          : (l = 'right'),
        { textAlign: l, x: c }
      );
    }
    ...
    return new Proxy(o, {
      ...
      get: (i, n) =>
        Ki(i, n, () =>
          (function (t, e, i, n) {
            let o;
            for (const s of e) if (((o = en(Xi(s, t), i)), ht(o))) return qi(t, o) ? Ji(i, n, t, o) : o;
          })(n, e, t, i)
        ),
  ...
  function Ui(t, e = { scriptable: !0, indexable: !0 }) {
    ...
    return { allKeys: o, scriptable: i, indexable: n, isScriptable: dt(i) ? i : () => i, isIndexable: dt(n) ? n : () => n };
  }
          ...
          l &&
            ...
            (Ot(e[h], 0, on)
              ...
              : ((o = i[h] / e[h]),
                ...
                r <= 9 || ((a = 3 / Math.sqrt(r)), (i[h] = o * a * e[h]), (i[h + 1] = s * a * e[h]))));
    })(t, i, n),
      (function (t, e) {
        const i = t.length;
        let n,
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ...
              r && ((o.cp2x = ln(o.cp2x, e.left, e.right)), (o.cp2y = ln(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  function hn(t, e, i, n) {
  ...
  function yn(t) {
    ...
    return (function (t, e, i, n) {
      ...
      for (a = e + 1; a <= i; ++a) {
        const i = t[a % o];
        i.skip || i.stop
          ? l.skip || ((n = !1), s.push({ start: e % o, end: (a - 1) % o, loop: n }), (e = r = i.stop ? a : null))
          : ((r = a), l.skip && (e = a)),
          (l = i);
      }
  ...
  function Cn(t, e) {
    return 'x' === t || 'y' === t
      ? t
      : e.axis ||
          ('top' === (i = e.position) || 'bottom' === i ? 'x' : 'left' === i || 'right' === i ? 'y' : void 0) ||
  ...
  function In(t, e, i) {
    ...
    let s = n.get(o);
    if (!s) {
      (s = { resolver: $i(e, i), subPrefixes: i.filter(t => !t.toLowerCase().includes('hover')) }), n.set(o, s);
    }
    return s;
  }
  ...
  function Nn(t) {
    return (
      Hn() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t
    );
  }
  const jn = {},
    $n = t => {
  ...
  class Yn {
    constructor(t, e) {
      ...
      (this.id = j()),
        ...
        (jn[n.id] = n),
        l && c
          ? (a.listen(n, 'complete', Bn), a.listen(n, 'progress', Wn), n._initialize(), n.attached && n.update())
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          Object.assign(i.prototype, { dataElementType: wn.getElement(r), datasetElementType: o && wn.getElement(o) }),
    ...
    destroy() {
      ...
      t.config.clearCache(),
        e && (t.unbindEvents(), Xt(e, i), t.platform.releaseContext(i), (t.canvas = null), (t.ctx = null)),
    ...
    updateHoverStyle(t, e, i) {
      ...
      let o, s, a, r;
      for (
        'dataset' === e && ((o = this.getDatasetMeta(t[0].datasetIndex)), o.controller['_' + n + 'DatasetHoverStyle']()),
          a = 0,
          r = t.length;
        a < r;
        ++a
    ...
    _handleEvent(t, e) {
      ...
      let r = [],
        ...
        c = null;
      return (
        'mouseout' !== t.type && ((r = i.getElementsAtEventForMode(t, s.mode, s, a)), (c = 'click' === t.type ? i._lastEvent : t)),
        (i._lastEvent = null),
        Q(o.onHover, [t, r, i], i),
  ...
  class eo extends Ai {
    ...
    _calculateBarValuePixels(t) {
      ...
      f !== d && ((u = f - d), (f = d)),
        l && ((d = r.barStart), (f = r.barEnd - r.barStart), 0 !== d && Pt(d) !== Pt(r.barEnd) && (u = 0), (u += d));
      const g = $(o) || l ? u : o;
      let p = i.getPixelForValue(g);
      (c = this.chart.getDataVisibility(t) ? i.getPixelForValue(u + f) : p),
        (h = c - p),
        void 0 !== s && Math.abs(h) < s && ((h = h < 0 ? -s : s), 0 === d && (p -= h / 2), (c = p + h));
      const m = o || 0;
          ...
          l =
            'flex' === o.barThickness
              ...
              : (function (t, e, i, n) {
                  ...
                  let s, a;
                  return (
                    $(o) ? ((s = e.min * i.categoryPercentage), (a = i.barPercentage)) : ((s = o * n), (a = 1)),
  ...
  class io extends Ai {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let c, h, d;
      for (c = i, h = i + n; c < h; ++c)
        (d = e[c]), l.push({ x: o.parse(lt(d, a), c), y: s.parse(lt(d, r), c), _custom: d && d.r && +d.r });
      return l;
    }
    getMaxOverflow() {
  ...
  (io.id = 'bubble'),
    ...
    (io.overrides = { scales: { x: { type: 'linear' }, y: { type: 'linear' } }, plugins: { tooltip: { callbacks: { title: () => '' } } } });
  class no extends Ai {
    constructor(t, e) {
      super(t, e),
    ...
    _circumference(t, e) {
      ...
      return (e && n.animation.animateRotate) || !this.chart.getDataVisibility(t) || null === o._parsed[t]
        ? 0
  ...
  (oo.id = 'line'),
    (oo.defaults = { datasetElementType: 'line', dataElementType: 'point', showLine: !0, spanGaps: !1 }),
  ...
  function fo(t, e) {
    ...
    r.borderWidth &&
      (h ? ((t.lineWidth = 2 * r.borderWidth), (t.lineJoin = 'round')) : ((t.lineWidth = r.borderWidth), (t.lineJoin = 'bevel')),
      e.fullCircles &&
        (function (t, e, i) {
  ...
  function bo(t, e, i, n) {
    ...
    for (l && ((d = o[b(0)]), t.moveTo(d.x, d.y)), h = 0; h <= r; ++h) {
      ...
      const e = d.x,
        i = d.y,
        n = 0 | e;
      n === u ? (i < f ? (f = i) : i > g && (g = i), (m = (x * m + e) / ++x)) : (_(), t.lineTo(e, i), (u = n), (x = 0), (f = g = i)),
        (p = i);
    }
    _();
  }
  ...
  (go.id = 'arc'),
    (go.defaults = { borderAlign: 'center', borderColor: '#fff', borderWidth: 2, offset: 0, angle: void 0 }),
  ...
  class wo extends Oi {
    ...
    draw(t) {
      ...
      e.skip ||
        i.radius < 0.1 ||
        ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), qt(t, i, e.x, e.y));
    }
    getRange() {
  ...
  (wo.id = 'point'),
    (wo.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: 'circle', radius: 3, rotation: 0 }),
  ...
  class Ro extends Oi {
    ...
    draw(t) {
      ...
      var s;
      t.save(),
        (n.w === i.w && n.h === i.h) || (t.beginPath(), o(t, n), t.clip(), o(t, i), (t.fillStyle = e.borderColor), t.fill('evenodd')),
        t.beginPath(),
        o(t, i),
            ...
            h = (function (t, e, i) {
              ...
              for (o[d++] = t[u], a = 0; a < n - 2; a++) {
                ...
                const m = Math.floor(a * s) + 1,
                  ...
                  { x: b, y: _ } = t[u];
                for (l = c = -1, e = m; e < x; e++)
                  (c = 0.5 * Math.abs((b - i) * (t[e].y - _) - (b - t[e].x) * (n - _))), c > l && ((l = c), (r = t[e]), (h = e));
                (o[d++] = r), (u = h);
              }
  ...
  function Bo(t) {
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          let l, c, h;
          if (((h = 'start' === i ? a : 'end' === i ? r : U(i) ? i.value : e.getBaseValue()), n.grid.circular))
            return (c = e.getPointPositionForValue(0, a)), new Vo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) });
        ...
        for (let t = 0; t < n.length; t++) {
          ...
          for (let t = 0; t < c.length; ++t) {
            ...
            for (let t = 0; t < h.length; t++)
              a.push({ source: h[t], target: e, start: { [i]: qo(l, n, 'start', Math.max) }, end: { [i]: qo(l, n, 'end', Math.min) } });
          }
        }
        return a;
      })(i, n, o);
      ...
      for (r = 0; r < n; ++r)
        (a = t.getDatasetMeta(r)),
          ...
          l &&
            l.options &&
            l instanceof vo &&
            (c = { visible: t.isDatasetVisible(r), index: r, fill: zo(l, r, n), chart: t, scale: a.vScale, line: l }),
          (a.$filler = c),
          s.push(c);
      ...
      s &&
        ...
        (function (t, e) {
          ...
          t.save(),
            'x' === l &&
              s !== o &&
              (Uo(t, n, a.top), Zo(t, { line: i, target: n, color: o, scale: r, property: l }), t.restore(), t.save(), Uo(t, n, a.bottom)),
  ...
  const Jo = (t, e) => {
    ...
    return t.usePointStyle && ((i = Math.min(i, e)), (n = Math.min(n, e))), { boxWidth: n, boxHeight: i, itemHeight: Math.max(e, i) };
  };
  class ts extends Oi {
    constructor(t) {
      super(),
    ...
    fit() {
      ...
      let c, h;
      (i.font = o.string),
        t.isHorizontal() ? ((c = t.maxWidth), (h = t._fitRows(a, s, r, l) + 10)) : ((h = t.maxHeight), (c = t._fitCols(a, s, r, l) + 10)),
    ...
    _fitRows(t, e, i, n) {
      ...
      return (
        o.legendItems.forEach((t, o) => {
          ...
          (0 === o || c[c.length - 1] + g + 2 * r > a) && ((d += h), (c[c.length - (o > 0 ? 0 : 1)] = 0), (f += h), u++),
    ...
    _fitCols(t, e, i, n) {
      ...
      return (
        o.legendItems.forEach((t, o) => {
          ...
          o > 0 && f + e + 2 * r > h && ((d += u + r), c.push({ width: u, height: f }), (g += u + r), m++, (p = 0), (u = f = 0)),
            (u = Math.max(u, a)),
            (f += e + r),
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const l of i)
          l.col !== a && ((a = l.col), (r = o(n, t.top + e + s, t.bottom - t.columnSizes[a].height))),
            (l.top = r),
            (l.left += t.left + s),
            (r += l.height + s);
      }
    ...
    _draw() {
      ...
      t.legendItems.forEach((e, u) => {
        ...
        h.setWidth(t.width),
          y
            ? u > 0 && P + S + f > t.right && ((D = m.y += M), m.line++, (P = m.x = o(r, t.left + f, t.right - n[m.line])))
            : u > 0 &&
              D + M > t.bottom &&
              ((P = m.x = P + i[m.line].width + f), m.line++, (D = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)));
        !(function (t, e, i) {
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ...
          : ('left' === a.position ? ((c = i + t), (h = o(r, n, e)), (d = -0.5 * xt)) : ((c = s - t), (h = o(r, e, n)), (d = 0.5 * xt)),
            (l = n - e)),
  ...
  function ls(t, e) {
    ...
    if (
      ((x += t.beforeBody.length + t.afterBody.length), d && (p += d * c.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom), x)
    ) {
  ...
  function cs(t, e, i, n) {
    ...
    let c = 'center';
    return (
      'center' === n ? (c = o <= (r + l) / 2 ? 'left' : 'right') : o <= s / 2 ? (c = 'left') : o >= a - s / 2 && (c = 'right'),
      (function (t, e, i, n) {
        const { x: o, width: s } = n,
  ...
  function ds(t, e, i, n) {
    ...
    return (
      'center' === l ? ('left' === r ? (d += c) : 'right' === r && (d -= c)) : 'left' === r ? (d -= h) : 'right' === r && (d += h),
  ...
  class ps extends Oi {
    ...
    update(t, e) {
      ...
      if (o.length) {
        ...
        (i.xAlign = l.xAlign),
          (i.yAlign = l.yAlign),
          (s = { opacity: 1, x: c.x, y: c.y, width: e.width, height: e.height, caretX: t.x, caretY: t.y });
    ...
    getCaretPosition(t, e, i) {
      ...
      return (
        'center' === o
          ? ((p = l + h / 2),
            'left' === n ? ((d = r), (u = d - a), (g = p + a), (m = p - a)) : ((d = r + c), (u = d + a), (g = p - a), (m = p + a)),
            (f = d))
          : ((u = 'left' === n ? r + s + a : 'right' === n ? r + c - s - a : this.caretX),
            'top' === o ? ((g = l), (p = g - a), (d = u - a), (f = u + a)) : ((g = l + h), (p = g + a), (d = u + a), (f = u - a)),
            (m = g)),
    ...
    handleEvent(t, e) {
      ...
      return (
        (s = e || !tt(a, o) || r),
        s && ((i._active = a), (n.enabled || n.external) && ((i._eventPosition = { x: t.x, y: t.y }), i.update(!0, e))),
        s
      );
    }
  ...
  class _s extends ji {
    ...
    parse(t, e) {
      ...
      return ((t, e) =>
        null === t ? null : Ht(Math.round(t), 0, e))((e = isFinite(e) && i[e] === t ? e : bs(i, t, K(e, t))), i.length - 1);
    }
    determineDataLimits() {
      const t = this,
  ...
  class ys extends ji {
    ...
    getTickLimit() {
      ...
      return (
        o ? (i = Math.ceil(t.max / o) - Math.floor(t.min / o) + 1) : ((i = t.computeTickLimit()), (n = n || 11)),
        n && (i = Math.min(n, i)),
        i
      );
    }
      ...
      const o = (function (t, e) {
        ...
        (_ = Math.ceil(u / y) - Math.floor(d / y)),
          ...
          f && g && n && Tt((s - o) / n, y / 1e3)
            ...
            : ((_ = (b - x) / y), (_ = Ot(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_))),
          (m = Math.pow(10, $(a) ? It(y) : a)),
          (x = Math.round(x * m) / m),
          (b = Math.round(b * m) / m);
        let v = 0;
        for (f && (i.push({ value: o }), x <= o && v++, Ot(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v)
  ...
  class ws extends ji {
    ...
    buildTicks() {
      ...
      return (
        ...
        e.reverse ? (i.reverse(), (t.start = t.max), (t.end = t.min)) : ((t.start = t.min), (t.end = t.max)),
        i
      );
    }
    getLabelForValue(t) {
  ...
  function Ss(t, e, i, n, o) {
    return t === n || t === o ? { start: e - i / 2, end: e + i / 2 } : t < n || t > o ? { start: e - i, end: e } : { start: e, end: e + i };
  }
  function Ps(t) {
        ...
        ? (function (t) {
            ...
            for (n = 0; n < l; n++) {
              ...
              (t.ctx.font = u.string),
                (c = t.ctx),
                (h = u.lineHeight),
                (o = Y((d = t._pointLabels[n])) ? { w: Yt(c, c.font, d), h: d.length * h } : { w: c.measureText(d).width, h: h }),
                (a[n] = o);
  ...
  (Os.id = 'radialLinear'),
    (Os.defaults = {
      ...
      grid: { circular: !1 },
      startAngle: 0,
      ticks: { showLabelBackdrop: !0, backdropColor: 'rgba(255,255,255,0.75)', backdropPadding: 2, callback: Ei.formatters.numeric },
      pointLabels: { backdropColor: void 0, backdropPadding: 2, display: !0, font: { size: 10 }, callback: t => t, padding: 5 },
    }),
    (Os.defaultRoutes = { 'angleLines.color': 'borderColor', 'pointLabels.color': 'color', 'ticks.color': 'color' }),
  ...
  function Es(t, e) {
    ...
    return (
      ...
      null === r ? null : (s && (r = 'week' !== s || (!At(a) && !0 !== a) ? i.startOf(r, s) : i.startOf(r, 'isoWeek', a)), +r)
    );
  }
  function Is(t, e, i, n) {
    const o = Ls.length;
  ...
  class Vs extends ji {
    ...
    determineDataLimits() {
      ...
      (a && r) || (l(t._getLabelBounds()), ('ticks' === e.bounds && 'labels' === e.ticks.source) || l(t.getMinMax(!1))),
      ...
      return (
        ...
        (t._majorUnit =
          n.major.enabled && 'year' !== t._unit
            ? (function (t) {
                for (let e = Ls.indexOf(t) + 1, i = Ls.length; e < i; ++e) if (Ts[Ls[e]].common) return Ls[e];
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      ...
      let d,
        u,
        f = i;
      if ((c && (f = +e.startOf(f, 'isoWeek', l)), (f = +e.startOf(f, c ? 'day' : a)), e.diff(n, i, a) > 1e5 * r))
