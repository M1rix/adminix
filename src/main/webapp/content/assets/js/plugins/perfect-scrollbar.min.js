 ...
 */ (function (a, b) {
    ...
    (a.containerWidth = b(g.width)),
      ...
      !a.settings.suppressScrollX && a.containerWidth + a.settings.scrollXMarginOffset < a.contentWidth
        ? ((a.scrollbarXActive = !0),
          ...
          (a.scrollbarXLeft = n(
            ((a.negativeScrollAdjustment + c.scrollLeft) * (a.railXWidth - a.scrollbarXWidth)) / (a.contentWidth - a.containerWidth)
          )))
      ...
      a.scrollbarYActive
        ...
        : (c.classList.remove(z.state.active('y')), (a.scrollbarYHeight = 0), (a.scrollbarYTop = 0), (c.scrollTop = 0));
  }
  function r(a, b) {
    var c = Math.min,
      d = Math.max;
  ...
  function s(a, c) {
    ...
    c.isScrollbarYUsingRight
      ...
      : c.isRtl
      ? (f.left =
          c.negativeScrollAdjustment + a.scrollLeft + 2 * c.containerWidth - c.contentWidth - c.scrollbarYLeft - c.scrollbarYOuterWidth)
    ...
    function f(b, e) {
      (t = s[o]),
        ...
        e
          ...
          : (a.event.bind(a.ownerDocument, 'mousemove', c), a.event.once(a.ownerDocument, 'mouseup', d), b.preventDefault()),
          ...
          if (!f(a.target, g, i)) {
            ...
            b.settings.useBothWheelAxes
              ? b.scrollbarYActive && !b.scrollbarXActive
                ...
                : b.scrollbarXActive &&
                  !b.scrollbarYActive &&
                  (g ? (h.scrollLeft += g * b.settings.wheelSpeed) : (h.scrollLeft -= i * b.settings.wheelSpeed), (j = !0))
            ...
            : E.supportsIePointer &&
              (window.PointerEvent
                ...
                : window.MSPointerEvent &&
                  (b.event.bind(l, 'MSPointerDown', h), b.event.bind(l, 'MSPointerMove', j), b.event.bind(l, 'MSPointerUp', k)));
        }
      },
    },
    H = function (d, e) {
      var f = this;
      if ((void 0 === e && (e = {}), 'string' == typeof d && (d = document.querySelector(d)), !d || !d.nodeName))
