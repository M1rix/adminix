...
!(function (t, e) {
        ...
        ? (function (t, e, i) {
            return function n(s) {
              ...
              for (let { target: r } = s; r && r !== this; r = r.parentNode)
                for (const a of o) if (a === r) return (s.delegateTarget = r), n.oneOff && P.off(t, s.type, e, i), i.apply(r, [s]);
            };
          })(t, i, n)
        : (function (t, e) {
            return function i(n) {
  ...
  class F extends B {
    constructor(t, e) {
      super(),
        (t = r(t)) && ((this._element = t), (this._config = this._getConfig(e)), j.set(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
  ...
  class rt extends F {
    ...
    _slide(t, e = null) {
      ...
      const o = this._getItemIndex(s),
        r = e =>
          P.trigger(this._element, e, { relatedTarget: s, direction: this._orderToDirection(t), from: this._getItemIndex(i), to: o });
  ...
  function he(t) {
    ...
    if (c) {
      ...
      A === Wt(i) && 'static' !== Gt((A = Zt(i))).position && 'absolute' === a && ((E = 'scrollHeight'), (T = 'scrollWidth')),
        (s === pt || ((s === _t || s === mt) && o === wt)) &&
          ((y = gt), (g -= (d && A === w && w.visualViewport ? w.visualViewport.height : A[E]) - n.height), (g *= l ? 1 : -1)),
        (s !== _t && ((s !== pt && s !== gt) || o !== wt)) ||
          ((v = mt), (f -= (d && A === w && w.visualViewport ? w.visualViewport.width : A[T]) - n.width), (f *= l ? 1 : -1));
    }
    var C,
    ...
    return (
      ...
      l
        ? Object.assign(
            ...
            (C[v] = _ ? '0' : ''),
            (C.transform =
              (w.devicePixelRatio || 1) <= 1 ? 'translate(' + f + 'px, ' + g + 'px)' : 'translate3d(' + f + 'px, ' + g + 'px, 0)'),
            C)
          )
    ...
    fn: function (t) {
      ...
      null != e.modifiersData.popperOffsets &&
        (e.styles.popper = Object.assign(
          {},
          e.styles.popper,
          he(Object.assign({}, c, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: r, roundOffsets: l }))
        )),
        null != e.modifiersData.arrow &&
          (e.styles.arrow = Object.assign(
            {},
            e.styles.arrow,
            he(Object.assign({}, c, { offsets: e.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets: l }))
          )),
      ...
      : Ee(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              'rtl' === Gt(s || i).direction && (a += Vt(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
            );
          })(Zt(t))
        );
  }
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [m].concat(b).reduce(function (t, i) {
              return t.concat(
                qt(i) === bt
                  ? xe(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: g })
                  : i
              );
            }, []),
            y = e.rects.reference,
  ...
  function Me(t, e, i) {
    ...
    return (
      (o || (!o && !i)) &&
        (('body' !== $t(e) || ye(a)) &&
          (c = (n = e) !== Wt(n) && Ft(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : be(n)),
        ...
        h = {
          ...
          setOptions: function (i) {
            ...
            d(),
              ...
              (a.scrollParents = { reference: Bt(t) ? Ae(t) : t.contextElement ? Ae(t.contextElement) : [], popper: Ae(e) });
            var r,
              c,
              u = (function (t) {
                var e = je(t);
  ...
  class rn extends F {
    ...
    _fixTitle() {
      ...
      t &&
        (this._element.getAttribute('aria-label') || this._element.textContent || this._element.setAttribute('aria-label', t),
  ...
  class Cn extends F {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          (this._setInitialAttributes(this._parent, this._getChildren()), P.on(this._element, 'keydown.bs.tab', t => this._keydown(t)));
    }
    static get NAME() {
      return 'tab';
    }
