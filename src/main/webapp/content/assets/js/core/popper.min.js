...
!(function (e, t) {
          ...
          (function (e) {
            ...
            return (
              o &&
                ((i = o.width),
                (a = o.height),
                /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((s = o.offsetLeft), (f = o.offsetTop))),
  ...
  function I(e, t, o) {
    var s =
      ...
      u = f.reduce(function (t, n) {
        var r = N(e, n);
        return (
          (t.top = i(r.top, t.top)), (t.right = a(r.right, t.right)), (t.bottom = a(r.bottom, t.bottom)), (t.left = i(r.left, t.left)), t
        );
      }, N(e, c));
  ...
  function te(e) {
    ...
    if (l) {
      ...
      if (i === A || ((i === j || i === E) && a === k))
        (P = D), (g -= (m && B === W && W.visualViewport ? W.visualViewport.width : B[T]) - o.width), (g *= p ? 1 : -1);
    }
    var R,
    ...
    return (
      ...
      p
        ? Object.assign(
            ...
            (R[P] = w ? '0' : ''),
            (R.transform =
              (W.devicePixelRatio || 1) <= 1 ? 'translate(' + g + 'px, ' + b + 'px)' : 'translate3d(' + g + 'px, ' + b + 'px, 0)'),
            R)
          )
        ...
        for (
          var o = n.mainAxis,
            ...
            b = [v].concat(y).reduce(function (e, n) {
              return e.concat(
                C(n) === L
                  ? ce(t, { placement: n, boundary: p, rootBoundary: u, padding: c, flipVariations: h, allowedAutoPlacements: m })
                  : n
              );
            }, []),
            x = t.rects.reference,
  ...
  var de = {
    ...
    fn: function (e) {
      ...
      if (i && a) {
        var p = (function (e, t) {
            return z(
              'number' != typeof (e = 'function' == typeof e ? e(Object.assign({}, t.rects, { placement: t.placement })) : e) ? e : X(e, P)
            );
          })(o.padding, n),
          u = v(i),
          l = 'y' === f ? j : A,
