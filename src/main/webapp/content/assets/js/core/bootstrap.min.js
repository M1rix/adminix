...
!(function (t, e) {
        ...
        ? (function (t, e, i) {
            return function s(n) {
              ...
              for (let { target: r } = n; r && r !== this; r = r.parentNode)
                for (const a of o) if (a === r) return (n.delegateTarget = r), s.oneOff && $.off(t, n.type, e, i), i.apply(r, [n]);
            };
          })(t, i, s)
        : (function (t, e) {
            return function i(s) {
  ...
  class R extends W {
    constructor(t, e) {
      super(),
        (t = c(t)) && ((this._element = t), (this._config = this._getConfig(e)), H.set(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
  ...
  class ct extends R {
    ...
    _slide(t, e = null) {
      ...
      const o = this._getItemIndex(n),
        r = e =>
          $.trigger(this._element, e, { relatedTarget: n, direction: this._orderToDirection(t), from: this._getItemIndex(i), to: o });
  ...
  const mt = 'dropdown',
    ...
    Nt = { offset: [0, 2], boundary: 'clippingParents', reference: 'toggle', display: 'dynamic', popperConfig: null, autoClose: !0 },
    Pt = {
  ...
  const _e = new Set(['background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href']),
    ...
    be = { extraClass: '', template: '<div></div>', content: {}, html: !1, sanitize: !0, sanitizeFn: null, allowList: me },
    ve = {
  ...
  class Ge extends R {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          (this._setInitialAttributes(this._parent, this._getChildren()), $.on(this._element, 'keydown.bs.tab', t => this._keydown(t)));
    }
    static get NAME() {
      return 'tab';
    }
  ...
  $.on(document, 'click.bs.tab', Ye, function (t) {
    ...
    $.on(window, 'load.bs.tab', () => {
      for (const t of Y.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]'))
